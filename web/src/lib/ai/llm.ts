...
export async function chatComplete(opts: {
  ...
  // NOTE: assistant prefill is NOT usable here — Sonnet 5 rejects a trailing
  // assistant turn with "This model does not support assistant message prefill".
  // The JSON contract is held by the reminder appended to the final user message
  // in engine.ts, which measured 0 retries in 50 replies.
